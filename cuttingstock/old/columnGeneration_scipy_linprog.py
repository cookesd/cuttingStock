...
##### tests #####
def test_updateBinv():
    B0inv = np.diag(np.array([.2,(1.0/3),1]))
    abar = np.array([[.2],[1.0/3],[1]])
    lvrow = 2
    B1inv = updateBinv(B0inv,abar,lvrow)
    print(B1inv)
